    ...
    return(
        ...
        <div className="flex flex-row w-full m-4 py-10">
            ...
            <div className="flex justify-end ml-8">
                <img src="https://res.cloudinary.com/storylens/image/upload/v1704433750/b7br9cxlnynhr5p82pfw.jpg" height="900" width="500"/>
            </div>
            <div className="flex flex-col w-1/2 ml-12 mt-8">
                <div>
        ...
        <div className="flex flex-col w-1/2 ml-12 mt-24">
            ...
            <div className="flex justify-end ml-8">
                <img src="https://res.cloudinary.com/storylens/image/upload/v1704433750/ebpmylutb4wlo0knvsbz.jpg" height="900" width="500"/>
            </div>
