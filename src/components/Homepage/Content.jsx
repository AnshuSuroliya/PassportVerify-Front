...
return(
    <div className="w-full h-full px-5 py-36 ml-8">
    <div className="w-96 h-65">
        <h1 className="text-7xl text-white font-serif">Welcome to PassportPro</h1>
        </div> 
        <p className="text-white text-lg font-serif mt-6 font-bold">Fast,reliable and secure passport verification online.</p>
